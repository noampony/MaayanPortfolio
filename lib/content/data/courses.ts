...
const courseData = [
  {
    // Sourced from the owner's CV ("Shani Penkar - CV" → Education). `certificateLink` is
    // the Bootcamp Certificate link the CV itself publishes (tracking param stripped).
    // ⚠️ Not access-checked (§10.9) - this module is data-only and nothing renders the
    // link today; verify it opens without a "request access" wall before any UI uses it.
    name: "The Complete Web Development Bootcamp",
    provider: "Udemy",
    category: ["Web Development", "Full Stack Development"],
    completionDate: "2023",
    description:
      "Full-stack web development bootcamp focused on frontend and backend development with JavaScript, Node.js, Express.js, and React.js.",
    skillsSharpened: [
      "JavaScript",
      "Node.js",
      "Express.js",
    ...
    certificateLink: "https://drive.google.com/file/d/1sKK-0bGh8a6wKXqehpISKnZElRF7PNC_/view",
  },
  {
