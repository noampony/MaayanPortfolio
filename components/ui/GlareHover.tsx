...
/**
 * Default sweep colour: an accent tint, not white. The theme's plates are already
 * near-white, so a white glare has nothing to lighten and never reads. Because this is
 * a `color-mix()` string rather than a hex, its own alpha governs and `glareOpacity` is
 * ignored - pass a hex if you want `glareOpacity` to apply.
 */
const DEFAULT_GLARE_COLOR = "color-mix(in srgb, var(--accent) 16%, transparent)";
