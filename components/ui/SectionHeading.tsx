...
/**
 * Shared section heading - the `<h2>`, the colourful left accent line and an
 * optional lead paragraph, in the one visual rhythm every homepage section uses. Purely presentational: it carries variants but no
