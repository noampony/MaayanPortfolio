 ...
 * automatically when the native `<dialog>` card closes; {@link FloatingCard}
 * uses `ref` to drop that focus ring after an Escape-driven close.
 */
...
export function CardTrigger({ open, onClick, ref }: CardTriggerProps) {
  return (
    <button
      ref={ref}
      type="button"
